...
// Note: The certifier library and utilities are application programs so under
//  the "Linux-syscall" exception, this file as used by them is
//  under Apache 2.0.  However, if you include this include file in a
//  kernel module, it must be licensed under GPL 2.0.
